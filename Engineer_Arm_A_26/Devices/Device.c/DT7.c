...
void DT7_Init(void)
{
	HAL_UARTEx_ReceiveToIdle_DMA(&huart1,DT7_Rx_Data,sizeof(DT7_Rx_Data));
}
...
//	{
		...
		{
        Arm_Data.J3_targetlocation = RC_CtrlData.rc.ch3 * 6.206f + 4096.0f;  //左手上下
			  Arm_Data.J4_targetlocation = RC_CtrlData.rc.ch2 * 6.206f + 4096.0f;  //左手左右
			  Arm_Data.J5_targetlocation = RC_CtrlData.rc.ch1 * 6.206f + 4096.0f;  //右手上下
			  Arm_Data.J6_targetlocation = RC_CtrlData.rc.ch0 * 6.206f + 4096.0f;  //右手左右
		}
		else
		{
