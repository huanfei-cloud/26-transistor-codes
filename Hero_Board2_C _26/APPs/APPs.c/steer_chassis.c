...
void move_motor_speed_set(void)
{
    ...
    //chassis_control.motor_omega[0] =  sqrt( pow(((chassis_control.Speed_ToChassis).vy + (chassis_control.Speed_ToChassis).wz * Radius * 0.707107f),2) + pow(((chassis_control.Speed_ToChassis).vx - (chassis_control.Speed_ToChassis).wz * Radius * 0.707107f),2)) * wheel_rpm_ratio ;
    //chassis_control.motor_omega[1] =  sqrt( pow(((chassis_control.Speed_ToChassis).vy - (chassis_control.Speed_ToChassis).wz * Radius * 0.707107f),2) + pow(((chassis_control.Speed_ToChassis).vx - (chassis_control.Speed_ToChassis).wz * Radius * 0.707107f),2)) * wheel_rpm_ratio ;
    //chassis_control.motor_omega[2] =  sqrt( pow(((chassis_control.Speed_ToChassis).vy - (chassis_control.Speed_ToChassis).wz * Radius * 0.707107f),2) + pow(((chassis_control.Speed_ToChassis).vx + (chassis_control.Speed_ToChassis).wz * Radius * 0.707107f),2)) * wheel_rpm_ratio ;
    //chassis_control.motor_omega[3] =  sqrt( pow(((chassis_control.Speed_ToChassis).vy + (chassis_control.Speed_ToChassis).wz * Radius * 0.707107f),2) + pow(((chassis_control.Speed_ToChassis).vx + (chassis_control.Speed_ToChassis).wz * Radius * 0.707107f),2)) * wheel_rpm_ratio ;
