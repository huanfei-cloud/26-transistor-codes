...
FUZZYPID_Data_t fuzzy_pid_shoot_up = {0};
FUZZYPID_Data_t fuzzy_pid_shoot_down = {0};
FUZZYPID_Data_t fuzzy_pid_bullet_v = {0};
FUZZYPID_Data_t fuzzy_pid_bullet_l = {0};
FUZZYPID_Data_t fuzzy_pid_pitch_v = {0};
FUZZYPID_Data_t fuzzy_pid_pitch_l = {0};
FUZZYPID_Data_t fuzzy_pid_yaw_v = {0};
FUZZYPID_Data_t fuzzy_pid_yaw_l = {0};
#define NB -3
#define NM -2
#define NS -1
#define ZO 0
