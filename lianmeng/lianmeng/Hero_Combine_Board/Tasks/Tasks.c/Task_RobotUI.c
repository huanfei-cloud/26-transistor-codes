...
void Robot_UI(void const *argument)
{
    ...
    for (;;)
    {
      ...
      if(UI_PushUp_Counter % 301 == 0)
		{
			...
			UI_FUN.Line_Draw(&UI_Graph5.imageData[4], "005", UI_Graph_Add, 0, UI_Color_Green, 2,  945,  680,  945,  320);
		...
		{
			UI_FUN.Rectangle_Draw(&UI_Graph1.imageData[0],"007",UI_Graph_Add, 1, UI_Color_White, 3, 1500, 650, 1700 ,950);
      ...
      UI_FUN.Float_Draw(&UI_Graph7.imageData[1],"102", UI_Graph_Add, 1, UI_Color_White, 24, 2, 5, 1200, 200, 0.00);
			...
			//小陀螺速度
			UI_FUN.Float_Draw(&UI_Graph7.imageData[2],"103", UI_Graph_Add, 1, UI_Color_White, 20, 1, 5, 200, 810, ControlMes.z_rotation_velocity);

			//摩擦轮
			UI_FUN.Circle_Draw(&UI_Graph7.imageData[3],"104",UI_Graph_Add, 1, UI_Color_White, 15, 200, 800, 7);

			//自瞄
			UI_FUN.Circle_Draw(&UI_Graph7.imageData[4],"105",UI_Graph_Add, 1, UI_Color_White, 15, 200, 765, 7);
			
			//方向
			UI_FUN.Line_Draw(&UI_Graph7.imageData[5], "106", UI_Graph_Add, 1, UI_Color_Green, 5, 1600, 800, 1600+cos(0)*100, 800+sin(0)*100);

			//障碍线
			UI_FUN.Line_Draw(&UI_Graph7.imageData[6], "107", UI_Graph_Add, 1, UI_Color_Green, 5, 560, 10, 1400, 10);
      ...
      UI_FUN.Float_Draw(&UI_Graph7.imageData[1],"102", UI_Graph_Change, 1, UI_Color_White, 24, 1, 5, 1200, 200, CAP_Ratio);
			...
			//小陀螺速度
			UI_FUN.Float_Draw(&UI_Graph7.imageData[2],"103", UI_Graph_Change, 1, UI_Color_White, 20, 1, 5, 200, 850, Saber_Angle.Z_Vel);
			
			//摩擦轮
			if(ControlMes.fric_Flag == 0)
			{
			UI_FUN.Circle_Draw(&UI_Graph7.imageData[3],"104",UI_Graph_Change, 1, UI_Color_White, 15, 200, 800, 7);
			}
			else if(ControlMes.fric_Flag == 1)
			{
			UI_FUN.Circle_Draw(&UI_Graph7.imageData[3],"104",UI_Graph_Change, 1, UI_Color_Green, 15, 200, 800, 7);
			}
			...
			//方向
			UI_FUN.Line_Draw(&UI_Graph7.imageData[5], "106", UI_Graph_Change, 1, UI_Color_Green, 5, 1600, 800, 1600+cos(2*PI*M6020s_Yaw.realAngle/8192 - PI/6)*100, 800+sin(2*PI*M6020s_Yaw.realAngle/8192 - PI/6)*100);

			//障碍线
			UI_FUN.Line_Draw(&UI_Graph7.imageData[6], "107", UI_Graph_Change, 1, UI_Color_Green, 5, 560, 10, 1400, 10);
