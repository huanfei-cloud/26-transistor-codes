...
FUZZYPID_Data_t fuzzy_pid_fric_l={0};
FUZZYPID_Data_t fuzzy_pid_fric_r={0};
FUZZYPID_Data_t fuzzy_pid_fric_u={0};    //上摩擦轮
FUZZYPID_Data_t fuzzy_pid_dial_v={0};
FUZZYPID_Data_t fuzzy_pid_dial_l={0};
FUZZYPID_Data_t M6020s_YawO_FuzzyPID={0};
FUZZYPID_Data_t M6020s_YawI_FuzzyPID={0};
FUZZYPID_Data_t M6020s_AimYawO_FuzzyPID={0};
FUZZYPID_Data_t M6020s_AimYawI_FuzzyPID={0};
