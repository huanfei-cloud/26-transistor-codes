...
/********全局变量声明********/
extern motors_t M2006_roll;
/********函数声明********/
void motor_init(motors_t *motor, uint16_t _motor_id);
void get_motor_data(motors_t *motor,Can_Export_Data_t RxMessage);
void motor_velocity_change(motors_t *motor,CAN_HandleTypeDef *hcan,enum pid_control model, float target);
void motor_location_change(motors_t *motor, enum pid_control model, float target,float real);
