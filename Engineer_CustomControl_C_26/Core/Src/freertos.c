...
osThreadId Task_CustomControl_Handle;
...
extern void Custom_Control(void const *argument);
...
void MX_FREERTOS_Init(void) {
  ...
  /* add threads, ... */
   /* definition and creation of Can1ReceiveTask */
	...
	/* definition and creation of vofa_Task */	
		osThreadDef(CustomControl_Task, Custom_Control, osPriorityRealtime, 0, 256);
	  Task_CustomControl_Handle = osThreadCreate(osThread(CustomControl_Task), NULL);
